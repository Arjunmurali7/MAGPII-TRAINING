...
namespace EmployeeCollections // Namespace for employee management
{
    class Employee // Employee class to hold employee details
    {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do // Menu-driven interface
            {
                ...
                choice = int.Parse(Console.ReadLine()); // Read user choice

                switch (choice)// Switch case to handle user choices
                {
                    case 1:
                        // *Add Employee*
                        Console.Write("Enter Employee ID: "); // Read employee details
                    ...
                    case 2:
                        // *View Employees*
                        Console.WriteLine("\nEmployee List:");
                        var sorted = employees.OrderBy(e => e.Name);// Sort employees by name
                    ...
                    case 3:
                        ...
                        Employee empToUpdate = employees.Find(e => e.Id == updateId);// Find employee by ID

                        if (empToUpdate != null) // If employee found, update details
                        {
